...
import {Breadcrumb, BreadcrumbItem, Button, Col, Form, FormGroup, Input, Label, FormFeedback} from "reactstrap";
...
class  Contact extends Component {
    ...
    handleSubmit(event){
        ...
        console.log(alert(JSON.stringify(this.state)));
            ...
            <div className="container">
                <div className={"row"}>
                    <Breadcrumb>
                        ...
                        <BreadcrumbItem active>Contack Us</BreadcrumbItem>
                    </Breadcrumb>
                    ...
                    <div className="col-12 col-sm-11 offset-sm-1">
                        <div className="btn-group" role="group">
                            <a role="button" className="btn btn-primary" href="tel:+85212345678">
                                <i className="fa fa-phone"/> Call</a>
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                </Col>                                        <FormFeedback>{errors.firstname}</FormFeedback>
                            </FormGroup>
                            <FormGroup row>
